...
public class MapGrid : MonoBehaviour
{
    ...
    [SerializeField]
    private Vector2 gridPadding = new Vector2(12f, 20f);

    [SerializeField]
    private Color[] gridLevelColors = new Color[] { new Color(0, 0, 0, 0.2f), Color.black };

    [SerializeField]
    private float[] gridLevelCameraScales = new float[] { 1000f, 10000f };
